...
class TestUsersAPI:
    ...
    def test_login_valido(self, users_api, usuario_criado):
        response = users_api.verificar_login(usuario_criado["email"], usuario_criado["password"])
        body = response.json()
    ...
    def test_deletar_user(self, users_api, dados_usuario_teste):
        ...
        dados_usuario_teste["email"],
        dados_usuario_teste["password"]
        )
        ...
        response_busca = users_api.buscar_por_email(
        dados_usuario_teste["email"]
        )
